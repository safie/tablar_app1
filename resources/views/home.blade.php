@extends('tablar::page', ['layout' => 'fluid'])
            ...
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        ...
                        <a class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#modal-report"
                            ...
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a class="text-reset" href="invoice.html" tabindex="-1">Design Works</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="text-reset" href="invoice.html" tabindex="-1">UX Wireframes</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="text-reset" href="invoice.html" tabindex="-1">New Dashboard</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="text-reset" href="invoice.html" tabindex="-1">Landing Page</a>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="text-reset" href="invoice.html" tabindex="-1">Logo & Print</a>
                                        </td>
                                        <td>
                                            <span class="flag flag-country-us"></span>
                                            Apple
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="text-reset" href="invoice.html" tabindex="-1">Icons</a></td>
                                        <td>
                                            <span class="flag flag-country-pl"></span>
                                            Tookapic
                                        </td>
